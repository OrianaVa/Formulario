...
<head>
    ...
    <title>Desincorporación de usuario</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row">
                    <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                        <h4 class="page-title">Desincorporación de Usuario</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h1 class="box-title">Solicitud de Desincorporación de Usuario</h1>
                        </div>
                    </div>
                </div>
                <form method="POST" action="Templates/desincorporar.php" id="form">
                    <div class="col-md-6 center align-items-center">
                        <label text="Text">Por favor indique la cédula del usuario que desea desincorporar</label>
                        <div class="col-6">
                            <input type="number" name="cedula" class="form-control" id="cedula" value=""
                                placeholder="Cédula">
                        </div>
                        <div class="d-flex justify-content-center" id="boton">
                            <button class="btn btn-outline-primary" type="submit" value="delete" id="btn-eliminar"
                                name="btn-eliminar">Eliminar</button>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btn-eliminar").click(function () {
                ...
                var datos = {
                    cedula: String(document.getElementById("cedula").value),
                };
                if (isNaN(datos.cedula === "")) {
                    Swal.fire({
                        ...
                        Swal.fire({
                            title: '¿Desea desincorporar al usuario?',
                            showDenyButton: true,
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: 'POST',
                                    url: 'Templates/desincorporar.php',
                                    dataType: 'html',
                                    data: datos,
                                    success: function (data) {
                                        Swal.fire('Registro desincorporado!', '', 'success');
                                    }
                                });
                            }
                        });
